    ...
    }, 
    {
        ...
        cell: ({ row }) => (
          <div className="space-y-0.5">
            ...
            {row.original.user?.role === 'CLIENT' && <span className="text-3 font-normal color-black leading-5.5">Cliente</span>}
            {row.original.user?.role === 'ADMIN' && <span className="text-3 font-normal color-black leading-5.5">Administrador</span>}
          </div>
        ),
    },
    {
